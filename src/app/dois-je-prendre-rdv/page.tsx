  ...
  return (
    <>
      ...
      <main className="bg-gray-50">
          ...
          <div className={`max-w-[1200px] mx-auto px-6 relative z-10 transition-all duration-700 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="text-center max-w-5xl mx-auto">
              ...
              <p className="text-xl lg:text-3xl text-white/90 leading-relaxed mb-6">
                La majorité des examens sont réalisables <span className="font-bold text-cyan-300">sans rendez-vous</span>.
              </p>
        ...
        <section ref={infoRef as React.RefObject<HTMLElement>} className="py-16 bg-white">
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className={`mb-12 relative h-[300px] rounded-2xl overflow-hidden shadow-xl transition-all duration-700 ${infoVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-r from-[#0B3D5F]/70 to-transparent flex items-center">
            ...
            <div className={`grid md:grid-cols-3 gap-6 transition-all duration-700 ${infoVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-200 hover:shadow-lg transition-all">
                ...
                <h3 className="text-xl font-bold text-green-900 mb-2">80% Sans RDV</h3>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6 border-2 border-orange-200 hover:shadow-lg transition-all">
                ...
                <p className="text-gray-700">Nos laboratoires sont accessibles tous les jours pour votre commodité</p>
              </div>
        ...
        <section ref={greenRef as React.RefObject<HTMLElement>} className="py-20 lg:py-24">
          <div className="max-w-[1200px] mx-auto px-6">
            <div className={`transition-all duration-700 ${greenVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 lg:p-12 shadow-2xl border-l-8 border-green-500 mb-8">
                <div className="grid lg:grid-cols-2 gap-8">
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border border-green-200">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <h3 className="text-2xl font-bold text-green-900">Analyses de Sang Courantes</h3>
                    </div>
                    <ul className="space-y-4">
                      {[
                        ...
                        <li key={index} className="flex items-start gap-3 group hover:bg-green-50 p-2 rounded-lg transition-all">
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border border-green-200">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <h3 className="text-2xl font-bold text-green-900">Tests de Dépistage Rapide</h3>
                    </div>
                    <ul className="space-y-4">
                      {[
                        ...
                        <li key={index} className="flex items-start gap-3 group hover:bg-green-50 p-2 rounded-lg transition-all">
                          ...
                          <div className="flex-1">
                            <div className="flex items-start justify-between">
                              <span className="font-semibold text-gray-900">{item.name}</span>
                              <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full">{item.time}</span>
                            </div>
                            <p className="text-sm text-gray-600 mt-1">{item.desc}</p>
                          </div>
                        </li>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border border-green-200">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <h3 className="text-2xl font-bold text-green-900">Bilans Complets</h3>
                    </div>
                    <ul className="space-y-4">
                      {[
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border border-green-200">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <h3 className="text-2xl font-bold text-green-900">Analyses Spécialisées</h3>
                    </div>
                    <ul className="space-y-4">
                      {[
                ...
                <div className="mt-8 bg-green-100 border-l-4 border-green-500 p-6 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-green-900 mb-2 text-lg">💡 Conseil Pratique</h4>
                            ...
                            <div className="flex-1">
                              ...
                              <div className="space-y-2 mt-3 pt-3 border-t border-red-200">
                                ...
                                <div className="flex items-start gap-2">
                                  ...
                                  <p className="text-xs text-gray-600"><strong>Préparation:</strong> {item.prep}</p>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-red-50 p-5 rounded-lg border border-red-200">
                        ...
                        <ul className="space-y-2 ml-7">
                          <li className="text-sm text-gray-700">• Personnes à mobilité réduite</li>
                          <li className="text-sm text-gray-700">• Patients âgés ou alités</li>
                          <li className="text-sm text-gray-700">• Hospitalisation à domicile (HAD)</li>
                          <li className="text-sm text-gray-700">• Post-opératoire</li>
                        </ul>
                      </div>

                      <div className="bg-orange-50 p-5 rounded-lg border border-orange-200">
                        <h4 className="font-bold text-orange-900 mb-3">📋 Informations pratiques</h4>
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-2xl p-8 lg:p-12 shadow-2xl border-l-8 border-yellow-500">
                <div className="grid lg:grid-cols-2 gap-8 mb-8">
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border border-yellow-200">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <h3 className="text-2xl font-bold text-yellow-900">À Jeun - Mode d'emploi</h3>
                    </div>

                    <div className="space-y-4">
                      <div className="bg-yellow-50 p-5 rounded-lg border-2 border-yellow-300">
                        <h4 className="font-bold text-yellow-900 mb-3 text-lg">⏰ Durée du jeûne</h4>
                        <ul className="space-y-3">
                          <li className="flex items-start gap-3">
                            <span className="text-2xl">🕐</span>
                            <div>
                              <strong className="text-gray-900">8 à 12 heures</strong>
                              <p className="text-sm text-gray-700 mt-1">Pour la plupart des analyses (glycémie, bilan lipidique)</p>
                            </div>
                          </li>
                          <li className="flex items-start gap-3">
                            <span className="text-2xl">🕐</span>
                            <div>
                              <strong className="text-gray-900">12 à 14 heures</strong>
                              <p className="text-sm text-gray-700 mt-1">Pour les triglycérides et bilans complets</p>
                            </div>
                          </li>
                        </ul>
                      </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-white rounded-xl p-6 shadow-lg border border-yellow-200">
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-2xl font-bold text-orange-900">Activité Physique</h3>
                      </div>
                      <div className="space-y-4">
                        <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                          <p className="text-sm text-gray-700 mb-3">
                            <strong className="text-orange-900">48h avant votre prélèvement :</strong>
                          </p>
                          <ul className="space-y-2 text-sm text-gray-700">
                            <li className="flex items-start gap-2">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-lg border border-yellow-200">
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-2xl font-bold text-purple-900">Documents à Apporter</h3>
                      </div>
                      <ul className="space-y-3">
                        {[
                          { icon: "📋", name: "Ordonnance médicale", desc: "Si prescrite par votre médecin" },
                          { icon: "💳", name: "Carte Vitale", desc: "Pour le remboursement Sécurité Sociale" },
                          { icon: "🏥", name: "Carte de mutuelle", desc: "Pour le tiers payant" },
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-lg border border-yellow-200">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-2xl font-bold text-cyan-900">Conseils Généraux</h3>
                      </div>
                      <ul className="space-y-2 text-sm text-gray-700">
                        <li className="flex items-start gap-2">
                          <Check className="w-4 h-4 text-cyan-600 flex-shrink-0 mt-1" />
                ...
                <div className="bg-gradient-to-r from-yellow-100 to-orange-100 border-l-4 border-yellow-500 p-6 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-yellow-900 mb-2 text-lg">💡 Vous avez un doute ?</h4>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className={`bg-white rounded-lg p-4 border-2 ${example.rdv ? 'border-red-300 bg-red-50/50' : 'border-green-300 bg-green-50/50'}`}>
                        <h4 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                          {example.rdv ? <AlertCircle className="w-5 h-5 text-red-600" /> : <Check className="w-5 h-5 text-green-600" />}
        ...
        <section ref={processRef as React.RefObject<HTMLElement>} className="py-20 lg:py-24 bg-gradient-to-br from-cyan-50 to-blue-50">
          <div className="max-w-[1200px] mx-auto px-6">
            <div className={`transition-all duration-700 ${processVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="relative">
                {/* Timeline line */}
                <div className="hidden lg:block absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-cyan-300"></div>
                    ...
                    <div key={index} className="relative">
                      <div className={`flex flex-col lg:flex-row items-center gap-8 ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
                        ...
                        <div className={`flex-1 ${index % 2 === 0 ? 'lg:text-right' : 'lg:text-left'}`}>
                          <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-xl border-2 border-cyan-200 hover:shadow-2xl transition-all">
                            ...
                            <h3 className="text-2xl font-bold text-[#0B3D5F] mb-2">
                              {item.title}
                            </h3>
                        ...
                        <div className="relative z-10 flex-shrink-0">
                          <div className="w-20 h-20 bg-cyan-600 rounded-full flex items-center justify-center shadow-xl border-4 border-white">
                            <item.icon className="w-10 h-10 text-white" />
                          </div>
                          <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-cyan-600 text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl shadow-lg">
                            {item.step}
                          </div>
                        </div>
              ...
              <div className="mt-16 bg-white rounded-2xl p-8 shadow-xl border-2 border-cyan-200">
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-[#0B3D5F] mb-4">⏱️ Temps Total Estimé</h3>
                  <div className="text-5xl font-bold text-cyan-600 mb-2">20-30 min</div>
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            <div className={`transition-all duration-700 ${faqVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="max-w-4xl mx-auto space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    answer: "Les tarifs sont fixés par la Nomenclature de la Sécurité Sociale (tarifs conventionnés) :\n• **Avec ordonnance** : Remboursement à 60% par l'Assurance Maladie, le reste par votre mutuelle\n• **Tiers payant** : Pas d'avance de frais si vous avez une mutuelle partenaire\n• **Sans ordonnance** : Tarifs libres, devis fourni avant le prélèvement\n\nExemples de tarifs (avec ordonnance) :\n• NFS : 9,45 € (remboursé 5,67 €)\n• Glycémie : 3,78 € (remboursé 2,27 €)\n• Bilan lipidique complet : ~20 € (remboursé ~12 €)\n• TSH : 12,60 € (remboursé 7,56 €)"
                  },
                  {
                    question: "Acceptez-vous la carte Vitale et le tiers payant ?",
                    answer: "Oui, nous acceptons :\n• **Carte Vitale** : Lecture directe pour transmission à l'Assurance Maladie\n• **Tiers payant Sécurité Sociale** : Pour les patients en ALD, CMU-C, femmes enceintes\n• **Tiers payant mutuelle** : Avec la plupart des mutuelles partenaires (vérifier lors de l'accueil)\n\nSi vous n'avez pas votre carte Vitale, nous établissons une feuille de soins papier que vous enverrez à votre caisse d'Assurance Maladie."
                  },
                  {
                  ...
                  >
                    ...
                    >
                      <div className="flex items-start gap-4 flex-1">
                        ...
                        <h3 className="text-xl font-bold text-[#0B3D5F] pr-4">{faq.question}</h3>
                      </div>
              ...
              <div className="mt-12 text-center bg-purple-50 rounded-2xl p-8 border-2 border-purple-200">
                ...
                <h3 className="text-2xl font-bold text-[#0B3D5F] mb-3">
        ...
        <section id="contact" ref={contactRef as React.RefObject<HTMLElement>} className="py-20 lg:py-28 bg-gradient-to-br from-cyan-600 via-blue-700 to-blue-900 text-white relative overflow-hidden">
          <div className="absolute inset-0 opacity-10">
            ...
            <div className={`transition-all duration-700 ${contactVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border-2 border-white/20 hover:bg-white/15 transition-all">
                  ...
                  <a href="tel:+237XXXXXXXXX" className="text-3xl font-bold hover:text-cyan-200 transition-colors block mb-4">
                    +237 6XX XX XX XX
                  </a>
                  <p className="text-white/80 text-sm mb-4">
                  ...
                  <a
                    href="tel:+237XXXXXXXXX"
                    className="inline-flex items-center gap-3 bg-white text-cyan-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-all shadow-lg hover:shadow-xl"
                  >
                    <Phone className="w-5 h-5" />
                    Appeler maintenant
                  </a>
