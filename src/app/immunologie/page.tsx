        ...
        <section className="relative h-[500px] md:h-[600px] overflow-hidden">
          <div className="absolute inset-0">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#7C3AED]/90 to-[#7C3AED]/60"></div>
          </div>
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-2 bg-white/20 px-5 py-3 rounded-full">
                  ...
                  <span className="text-white text-lg font-medium">100+ tests/jour</span>
                </div>
                <div className="flex items-center gap-2 bg-white/20 px-5 py-3 rounded-full">
                  <Clock className="w-5 h-5 text-white" />
                  <span className="text-white text-lg font-medium">24h/24</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl group">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <h3 className="text-2xl font-bold text-white">Sérologie Infectieuse</h3>
                </div>
              </div>
              ...
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl group">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                <div className="absolute bottom-6 left-6 right-6">
                  <h3 className="text-2xl font-bold text-white">Auto-immunité</h3>
                </div>
              </div>
              ...
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl group">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                <div className="absolute bottom-6 left-6 right-6">
                  <h3 className="text-2xl font-bold text-white">Allergologie</h3>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-white">
              ...
              <div className="p-6">
                ...
                <p className="text-white/80">A, B, C, D, E</p>
              </div>
              <div className="p-6">
                <h3 className="text-3xl font-bold mb-2">Auto-Ac</h3>
                <p className="text-white/80">Anticorps auto-immuns</p>
              </div>
              <div className="p-6">
                <h3 className="text-3xl font-bold mb-2">Allergies</h3>
                <p className="text-white/80">IgE spécifiques</p>
              </div>
            </div>
          </div>
        </section>
