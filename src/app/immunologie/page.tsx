        ...
        <section className="relative h-[80vh] min-h-[600px] overflow-hidden">
          ...
          <div className="relative h-full max-w-7xl mx-auto px-6 flex flex-col justify-center">
            <nav className="absolute top-8 left-6 flex items-center gap-2 text-[#1034A6]/80 text-sm">
              ...
              <ChevronRight className="w-4 h-4 text-[#1034A6]/60" />
              <span className="text-[#1034A6] text-sm">Immunologie</span>
            </nav>

            <div className="max-w-3xl">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-[#1034A6]/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                  <Shield className="w-6 h-6 text-[#1034A6]" />
                </div>
                <span className="text-[#1034A6]/90 text-lg font-medium">Système Immunitaire</span>
              </div>
              ...
              <div className="flex flex-wrap gap-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[#1034A6] font-bold">24/7</p>
                    <p className="text-[#1034A6]/70 text-sm">Service continu</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#1034A6]/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <p className="text-[#1034A6] font-bold">100+</p>
                    <p className="text-[#1034A6]/70 text-sm">Tests/jour</p>
                  </div>
                </div>
              </div>
            </div>
