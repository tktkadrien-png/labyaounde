            ...
            <div className="max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-2 bg-white/20 px-5 py-3 rounded-full">
                  ...
                  <span className="text-white text-lg font-medium">Cultures automatisées</span>
                </div>
                <div className="flex items-center gap-2 bg-white/20 px-5 py-3 rounded-full">
                  <Clock className="w-5 h-5 text-white" />
                  <span className="text-white text-lg font-medium">Antibiogrammes</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl group">
                <Image
                  src="/cdc-aM5wJrZGKrY-unsplash.jpg"
                  alt="Bactériologie"
                  fill
              ...
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl group">
                <Image
                  src="/cdc-k0KRNtqcjfw-unsplash.jpg"
                  alt="Parasitologie"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                <div className="absolute bottom-6 left-6 right-6">
                  <h3 className="text-2xl font-bold text-white">Parasitologie</h3>
                </div>
              </div>

              <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl group">
                <Image
                  src="/cdc-IFdp1wpq5gs-unsplash.jpg"
                  alt="Mycologie"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                <div className="absolute bottom-6 left-6 right-6">
                  <h3 className="text-2xl font-bold text-white">Mycologie</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-gradient-to-br from-[#FE5000] to-[#CC4000]">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-white">
              <div className="p-6">
                <h3 className="text-3xl font-bold mb-2">ECBU</h3>
                <p className="text-white/80">Urine complète</p>
              </div>
              <div className="p-6">
                <h3 className="text-3xl font-bold mb-2">Hémoculture</h3>
                <p className="text-white/80">Automatisée</p>
              </div>
              <div className="p-6">
                <h3 className="text-3xl font-bold mb-2">Coproculture</h3>
                <p className="text-white/80">Selles complètes</p>
              </div>
              <div className="p-6">
                <h3 className="text-3xl font-bold mb-2">Antibiogramme</h3>
                <p className="text-white/80">Sensibilité</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="relative h-96 rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src="/cdc-w9KEokhajKw-unsplash.jpg"
                  alt="Analyse"
                  fill
                  className="object-cover"
                />
