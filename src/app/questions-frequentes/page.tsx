          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="space-y-4">
              {currentContent.faqs.map((faq, index) => (
                <div
                  key={index}
                  className="bg-white rounded-2xl border-2 border-[#84BDE3]/30 overflow-hidden hover:border-[#1E40AF] hover:shadow-lg transition-all"
                >
                  <button
                  ...
                  >
                    <div className="flex items-start gap-4 flex-1">
                      <div className="w-10 h-10 bg-[#1E40AF]/10 rounded-full flex items-center justify-center flex-shrink-0">
        ...
        <section className="py-16 bg-gradient-to-br from-[#00CED1]/10 to-[#00CED1]/10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-2xl p-8 lg:p-12 shadow-xl border-2 border-[#00CED1]/30 text-center">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-[#1E40AF] mb-4">{currentContent.review.title}</h2>
              <p className="text-lg text-[#1E40AF]/70 mb-8 max-w-2xl mx-auto">{currentContent.review.description}</p>

              {isAuthenticated && userEmail && (
                <div className="flex items-center justify-center gap-2 text-sm text-[#1E40AF]/70 mb-6">
              ...
              <button
                ...
                className="inline-flex items-center gap-3 bg-gradient-to-r from-[#1E40AF] to-[#3B82F6] text-white px-8 py-4 rounded-xl font-semibold hover:shadow-xl transition-all transform hover:scale-105"
              >
