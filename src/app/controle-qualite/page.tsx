          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-[#0A065D]/10 px-4 py-2 rounded-full mb-6">
                <Shield className="w-5 h-5 text-[#0A065D]" />
                <span className="text-[#0A065D] font-semibold text-sm sm:text-base">Excellence Analytique</span>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-[#0A065D]/10 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-[#0A065D] font-semibold text-sm sm:text-base">Processus de Contrôle</span>
              </div>
