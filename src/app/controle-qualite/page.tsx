          ...
          <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-4">
                ...
                <ChevronRight className="w-4 h-4 text-[#1034A6]/60" />
                <span className="text-[#1034A6] text-sm sm:text-base">Contrôle Qualité</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-2 bg-[#1034A6]/10 backdrop-blur-sm px-4 py-2 rounded-full border border-[#1034A6]/20">
                  <Activity className="w-5 h-5 text-[#1034A6]" />
                  <span className="text-[#1034A6] text-sm sm:text-base font-medium">Contrôle continu</span>
                </div>
                <div className="flex items-center gap-2 bg-[#1034A6]/10 backdrop-blur-sm px-4 py-2 rounded-full border border-[#1034A6]/20">
                  <Target className="w-5 h-5 text-[#1034A6]" />
                  <span className="text-[#1034A6] text-sm sm:text-base font-medium">Excellence validée</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-[#1E40AF]/10 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-[#1E40AF] font-semibold text-sm sm:text-base">Excellence Analytique</span>
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#1E40AF] mb-6">
                Notre Système de Contrôle Qualité
              </h2>
              <p className="text-lg sm:text-xl text-[#1E40AF]/70 max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-[#1E40AF]/10 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-[#1E40AF] font-semibold text-sm sm:text-base">Processus de Contrôle</span>
              </div>
              ...
              {[
                ...
                >
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-bold text-[#1E40AF] mb-2">{item.title}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {[
                ...
                return (
                  <div
                    key={index}
                    className="bg-[#84BDE3]/10 rounded-2xl p-8 shadow-lg border border-[#84BDE3]/30"
                  >
                    <div className="flex items-start gap-6">
                      ...
                      <div>
                        <h3 className="text-xl sm:text-2xl font-bold text-[#1E40AF] mb-3">{benefit.title}</h3>
                        <p className="text-[#1E40AF]/70 text-base sm:text-lg leading-relaxed">{benefit.description}</p>
                      </div>
                    </div>
                  </div>
                );
