                ...
                >
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm font-semibold text-[#0A065D] mb-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 sm:p-10 shadow-xl border border-gray-100">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-[#0A065D] to-[#0080FF] rounded-2xl mb-6">
