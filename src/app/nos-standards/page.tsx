          ...
          <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-4">
                ...
                <ChevronRight className="w-4 h-4 text-[#1034A6]/60" />
                <span className="text-[#1034A6] text-sm sm:text-base">{language === 'fr' ? 'Nos Standards' : 'Our Standards'}</span>
              </div>

              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#1034A6] mb-4 sm:mb-6 leading-tight drop-shadow-lg">
                {language === 'fr' ? 'Nos Standards' : 'Our Standards'}
              </h1>
              <p className="text-lg sm:text-xl md:text-2xl text-[#1034A6]/90 mb-6 sm:mb-8 leading-relaxed drop-shadow-md">
                {language === 'fr'
