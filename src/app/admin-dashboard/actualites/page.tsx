        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <Link
              ...
              className="inline-flex items-center gap-2 text-[#0B3D5F] hover:text-[#0B4D6F] mb-4"
            >
            ...
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                  <Newspaper className="w-8 h-8 text-[#0B3D5F]" />
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-gradient-to-r from-[#0B3D5F] to-[#0B4D6F] text-white px-6 py-3 rounded-xl font-semibold hover:shadow-xl transition-all"
              >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-5 h-5 text-[#0B3D5F] rounded focus:ring-2 focus:ring-[#0B3D5F]"
                  />
                ...
                <div className="flex gap-4">
                  <button
                    type="submit"
                    className="inline-flex items-center gap-2 bg-gradient-to-r from-[#0B3D5F] to-[#0B4D6F] text-white px-8 py-3 rounded-xl font-semibold hover:shadow-xl transition-all"
                  >
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <span className="bg-[#0B3D5F]/10 text-[#0B3D5F] px-3 py-1 rounded-full text-xs font-semibold">
                          {actualite.category}
                        </span>
                      </div>
                    ...
                    <div className="flex gap-2 ml-4">
                      ...
                      <button
                        ...
                        title="Modifier"
                      >
                        <Edit className="w-5 h-5 text-[#0B3D5F]" />
                      </button>
                      <button
