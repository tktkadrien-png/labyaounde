      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-gray-50 flex items-center justify-center py-12 sm:py-16 lg:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8 flex justify-center">
            <div className="w-24 h-24 bg-gradient-to-br from-[#2916F5] to-[#157DEC] rounded-full flex items-center justify-center shadow-xl">
          ...
          <div className="bg-gradient-to-br from-[#2916F5]/5 to-[#157DEC]/5 rounded-2xl p-8 border border-[#2916F5]/10 mb-8">
