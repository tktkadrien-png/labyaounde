      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-gray-50 flex items-center justify-center py-12 sm:py-16 lg:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8 flex justify-center">
            <div className="w-24 h-24 bg-gradient-to-br from-[#0B3D5F] to-[#0B4D6F] rounded-full flex items-center justify-center shadow-xl">
          ...
          <div className="bg-gradient-to-br from-[#0B3D5F]/5 to-[#0B4D6F]/5 rounded-2xl p-8 border border-[#0B3D5F]/10 mb-8">
