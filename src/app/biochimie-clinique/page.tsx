        ...
        <section className="relative h-[80vh] min-h-[600px] overflow-hidden">
          ...
          <div className="relative h-full max-w-7xl mx-auto px-6 flex flex-col justify-center">
            <nav className="absolute top-8 left-6 flex items-center gap-2 text-white/80 text-sm">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-white">Biochimie Clinique</span>
            </nav>
            ...
            <div className="max-w-3xl">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-white/90 text-lg font-medium">Excellence Diagnostique</span>
              </div>
              ...
              <div className="flex flex-wrap gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm">Tests disponibles</p>
                  </div>
                </div>
              </div>
            </div>
