            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 bg-[#0B3D5F]/10 px-4 py-2 rounded-full mb-6">
                  <Microscope className="w-5 h-5 text-[#0B3D5F]" />
                  <span className="text-[#0B3D5F] font-semibold text-sm sm:text-base">Technologies de Pointe</span>
                </div>
                ...
                <div className="prose prose-lg max-w-none text-gray-700 space-y-4 mb-8">
                  ...
                  <ul className="space-y-3 text-base sm:text-lg">
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-[#0B3D5F] mt-2 flex-shrink-0"></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              {[
                ...
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-[#0B3D5F] to-[#0B4D6F] rounded-xl flex items-center justify-center mb-4">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <div className="inline-flex items-center gap-2 bg-[#0B3D5F]/10 px-4 py-2 rounded-full mb-6">
                  <FlaskConical className="w-5 h-5 text-[#0B3D5F]" />
                  <span className="text-[#0B3D5F] font-semibold text-sm sm:text-base">Analyses Avancées</span>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-r from-gray-50 to-white p-6 rounded-xl border-l-4 border-[#0B3D5F]">
                ...
                <div className="space-y-6 text-base sm:text-lg text-white/90 leading-relaxed">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-white text-[#0B3D5F] px-6 py-3 rounded-lg font-semibold hover:bg-white/90 transition-all"
                    >
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/signup"
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#0B3D5F] to-[#0B4D6F] text-white px-8 py-4 rounded-xl font-semibold text-base sm:text-lg hover:shadow-xl transition-all hover:scale-105"
              >
                Créer un Compte
                <ChevronRight className="w-5 h-5" />
              </Link>
              <Link
                href="/#contact"
                className="inline-flex items-center justify-center gap-2 bg-white text-[#0B3D5F] px-8 py-4 rounded-xl font-semibold text-base sm:text-lg border-2 border-[#0B3D5F] hover:bg-[#0B3D5F] hover:text-white transition-all"
              >
                Nous Contacter
              </Link>
            </div>
