      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-[#2916F5]/10 px-4 py-2 rounded-full mb-6">
                <AlertCircle className="w-5 h-5 text-[#2916F5]" />
                <span className="text-[#2916F5] font-semibold text-sm sm:text-base">Notre Objectif</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <div className="bg-gradient-to-br from-[#2916F5] to-[#157DEC] rounded-2xl p-8 text-white shadow-xl">
              ...
              {[
                ...
                >
                  <div className="flex items-start gap-4 mb-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#2916F5] to-[#157DEC] rounded-xl flex items-center justify-center flex-shrink-0">
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-[#2916F5]/10 px-4 py-2 rounded-full mb-6">
                <UserCheck className="w-5 h-5 text-[#2916F5]" />
                <span className="text-[#2916F5] font-semibold text-sm sm:text-base">Organisation</span>
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Les Responsabilités
              </h2>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 sm:p-10 lg:p-12 shadow-xl border border-gray-100">
                <div className="flex flex-col md:flex-row items-start gap-8">
                  <div className="w-20 h-20 bg-gradient-to-br from-[#2916F5] to-[#157DEC] rounded-2xl flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-[#2916F5] flex-shrink-0 mt-1" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-[#2916F5] to-[#157DEC] rounded-2xl flex items-center justify-center mx-auto mb-6">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center">
                ...
                <p className="text-[#2916F5] font-semibold">+237 659 000 666</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center">
                ...
                <p className="text-[#2916F5] font-semibold break-all">contact@labyaounde.com</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-[#2916F5] to-[#157DEC] text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/#contact"
                className="inline-flex items-center justify-center gap-2 bg-white text-[#2916F5] px-8 py-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-white/90 transition-all hover:scale-105"
              >
                Nous Contacter
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-transparent text-white px-8 py-4 rounded-xl font-semibold text-base sm:text-lg border-2 border-white hover:bg-white hover:text-[#2916F5] transition-all"
              >
