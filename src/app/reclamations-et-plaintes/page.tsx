          ...
          <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-4">
                ...
                <ChevronRight className="w-4 h-4 text-[#1034A6]/60" />
                <span className="text-[#1034A6] text-sm sm:text-base">Réclamations et Plaintes</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-2 bg-[#1034A6]/10 backdrop-blur-sm px-4 py-2 rounded-full border border-[#1034A6]/20">
                  <FileText className="w-5 h-5 text-[#1034A6]" />
                  <span className="text-[#1034A6] text-sm sm:text-base font-medium">Traitement rapide</span>
                </div>
                <div className="flex items-center gap-2 bg-[#1034A6]/10 backdrop-blur-sm px-4 py-2 rounded-full border border-[#1034A6]/20">
                  <Shield className="w-5 h-5 text-[#1034A6]" />
                  <span className="text-[#1034A6] text-sm sm:text-base font-medium">Confidentialité garantie</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-[#1E40AF]/10 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-[#1E40AF] font-semibold text-sm sm:text-base">Notre Objectif</span>
              </div>
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-lg sm:text-xl text-[#1E40AF]/80 leading-relaxed">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-[#1E40AF]/10 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-[#1E40AF] font-semibold text-sm sm:text-base">Organisation</span>
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#1E40AF] mb-6">
                Les Responsabilités
              </h2>
              <p className="text-lg sm:text-xl text-[#1E40AF]/70 max-w-3xl mx-auto mb-8">
                Notre équipe dédiée au traitement de vos réclamations
              </p>
            </div>

            <div className="max-w-4xl mx-auto">
              <div className="bg-[#84BDE3]/10 rounded-2xl p-8 sm:p-10 lg:p-12 shadow-xl border border-[#84BDE3]/30">
                <div className="flex flex-col md:flex-row items-start gap-8">
                  <div className="w-20 h-20 bg-gradient-to-br from-[#1E40AF] to-[#3B82F6] rounded-2xl flex items-center justify-center flex-shrink-0">
                    <UserCheck className="w-10 h-10 text-white" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl sm:text-3xl font-bold text-[#1E40AF] mb-6">
                      Personne Responsable Désignée
                    </h3>
                    <p className="text-lg text-[#1E40AF]/80 leading-relaxed mb-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-[#1E40AF] flex-shrink-0 mt-1" />
                        <span className="text-[#1E40AF]/80">Formation spécialisée en gestion de réclamations</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-[#1E40AF] flex-shrink-0 mt-1" />
                        <span className="text-[#1E40AF]/80">Compétence en communication et médiation</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-[#1E40AF] flex-shrink-0 mt-1" />
                        <span className="text-[#1E40AF]/80">Disponibilité et réactivité garanties</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-[#1E40AF] flex-shrink-0 mt-1" />
                        <span className="text-[#1E40AF]/80">Pouvoir décisionnel pour résoudre les problèmes</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-[#84BDE3]/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#84BDE3]/30 text-center">
                ...
                <h3 className="text-xl font-bold text-[#1E40AF] mb-4">En Personne</h3>
                <p className="text-[#1E40AF]/70 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#84BDE3]/30 text-center">
                ...
                <h3 className="text-xl font-bold text-[#1E40AF] mb-4">Par Téléphone</h3>
                <p className="text-[#1E40AF]/70 leading-relaxed mb-4">
                  Contactez-nous directement pour exposer votre réclamation à notre équipe.
                </p>
                <p className="text-[#1E40AF] font-semibold">+237 659 000 666</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#84BDE3]/30 text-center">
                ...
                <h3 className="text-xl font-bold text-[#1E40AF] mb-4">Par Email</h3>
                <p className="text-[#1E40AF]/70 leading-relaxed mb-4">
                  Envoyez-nous un email détaillant votre réclamation.
                </p>
                <p className="text-[#1E40AF] font-semibold break-all">contact@labyaounde.com</p>
              </div>
            </div>
          </div>
        </section>
