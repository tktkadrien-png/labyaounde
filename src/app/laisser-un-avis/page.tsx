          ...
          <div className="max-w-md w-full text-center">
            <div className="py-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/"
                  className="inline-block px-8 py-4 bg-gradient-to-r from-[#0A065D] to-[#0080FF] text-white font-semibold rounded-xl
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-[#0A065D] via-[#0080FF] to-[#0909FF] text-white py-16">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#0A065D] focus:border-transparent transition-all appearance-none bg-white cursor-pointer"
                      >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#0A065D] focus:border-transparent transition-all"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#0A065D] focus:border-transparent transition-all placeholder:text-gray-400"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#0A065D] focus:border-transparent transition-all resize-none placeholder:text-gray-400"
                    />
                  </div>
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="w-full px-6 py-4 bg-gradient-to-r from-[#0A065D] to-[#0080FF] text-white font-semibold text-base rounded-xl
                ...
                <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center gap-3">
                          <div className="w-12 h-12 bg-gradient-to-br from-[#0A065D] to-[#0080FF] rounded-full flex items-center justify-center text-white font-bold text-lg">
                      ...
                      {review.service_type && (
                        <div className="inline-flex items-center gap-1 px-3 py-1 bg-[#0A065D]/10 text-[#0A065D] rounded-full text-xs font-medium mb-3">
                  ...
                  {existingReviews.length > 3 && (
                    <button
                      ...
                      className="w-full py-3 text-[#0A065D] font-medium hover:bg-[#0A065D]/5 rounded-xl transition-colors flex items-center justify-center gap-2"
                    >
