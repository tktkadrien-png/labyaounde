            ...
            <div className={`transition-all duration-700 ${section1Visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-12">
                ...
                <Link href="/dois-je-prendre-rdv#preparation" className="group">
                  <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-8 border-2 border-yellow-200 hover:border-yellow-400 hover:shadow-xl transition-all h-full">
                    ...
                    <h3 className="text-2xl font-bold text-yellow-900 mb-3">{t('essentialPreparation')}</h3>
                    <p className="text-gray-700 mb-4">
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            <div className={`text-center transition-all duration-700 ${ctaVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="flex flex-wrap gap-6 justify-center">
                ...
                <Link
                  href="/dois-je-prendre-rdv#preparation"
                  className="inline-flex items-center gap-3 bg-yellow-500 hover:bg-yellow-600 text-white px-8 py-4 rounded-lg font-semibold transition-all shadow-lg hover:shadow-xl text-lg"
                >
