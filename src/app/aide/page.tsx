              ...
              {currentContent.sections.map((section, index) => {
                ...
                return (
                  <Link
                    key={index}
                    href={section.link}
                    className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-100 hover:border-[#0A065D] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group"
                  >
                    <div className="flex items-start gap-4">
                      <div className="w-14 h-14 bg-gradient-to-br from-[#0A065D] to-[#0080FF] rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
