          ...
          <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-4">
                ...
                <ChevronRight className="w-4 h-4 text-[#1034A6]/60" />
                <span className="text-[#1034A6] text-sm sm:text-base">Empreintes Génétiques</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-2 bg-[#1034A6]/10 backdrop-blur-sm px-4 py-2 rounded-full border border-[#1034A6]/20">
                  ...
                  <span className="text-[#1034A6] text-sm sm:text-base font-medium">Cadre légal respecté</span>
                </div>
                <div className="flex items-center gap-2 bg-[#1034A6]/10 backdrop-blur-sm px-4 py-2 rounded-full border border-[#1034A6]/20">
                  <Clock className="w-5 h-5 text-[#1034A6]" />
                  <span className="text-[#1034A6] text-sm sm:text-base font-medium">Résultats sous 15 jours</span>
                </div>
              </div>
            </div>
          </div>
