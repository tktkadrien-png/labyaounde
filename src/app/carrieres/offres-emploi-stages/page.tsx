              ...
              <>
                <div className="max-w-4xl mx-auto">
                  <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-100 p-12 text-center">
                    <div className="w-20 h-20 bg-gradient-to-br from-[#0A065D]/10 to-[#0080FF]/10 rounded-full flex items-center justify-center mx-auto mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                      <Link
                        href="/contact"
                        className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#0A065D] to-[#0080FF] text-white px-8 py-4 rounded-xl font-semibold hover:shadow-xl transition-all hover:scale-105 shadow-lg"
                      >
                      ...
                      <Link
                        ...
                        className="inline-flex items-center justify-center gap-2 bg-white text-[#0A065D] border-2 border-[#0A065D] px-8 py-4 rounded-xl font-semibold hover:bg-[#0A065D] hover:text-white transition-all"
                      >
