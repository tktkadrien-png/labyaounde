                ...
                {news.map((item) => (
                  <div key={item.id} className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    {item.image_url && (
                      <div className="relative h-56">
                        ...
                        <div className="absolute top-4 left-4">
                          <span className="bg-[#2916F5] text-white px-3 py-1 rounded-full text-xs font-semibold">
                            {item.category}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="p-6">
                      ...
                      <button className="inline-flex items-center gap-2 text-[#2916F5] font-semibold hover:gap-3 transition-all">
