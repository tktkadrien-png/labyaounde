      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-gray-50">
        ...
        <section id="actualites" className="py-12 sm:py-16 lg:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-[#0A065D]/10 px-4 py-2 rounded-full mb-4">
                <Newspaper className="w-5 h-5 text-[#0A065D]" />
                <span className="text-[#0A065D] font-semibold text-sm">
            ...
            <div className="text-center">
              <Link
                ...
                className="inline-flex items-center gap-2 bg-gradient-to-r from-[#0A065D] to-[#0080FF] text-white px-8 py-4 rounded-xl font-semibold hover:shadow-xl transition-all hover:scale-105 shadow-lg"
              >
        ...
        <section id="offres-emploi-stages" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-gray-50 to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-[#0A065D]/10 px-4 py-2 rounded-full mb-4">
                <Briefcase className="w-5 h-5 text-[#0A065D]" />
                <span className="text-[#0A065D] font-semibold text-sm">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-start gap-4">
                        <div className="w-14 h-14 bg-gradient-to-br from-[#0A065D] to-[#0080FF] rounded-xl flex items-center justify-center flex-shrink-0">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4 text-sm text-gray-600 mb-3">
                            ...
                            <div className="flex items-center gap-2">
                              <Calendar className="w-4 h-4 text-[#0A065D]" />
                              {job.date}
                            </div>
                            <span className="bg-[#0A065D]/10 text-[#0A065D] px-3 py-1 rounded-full font-medium">
                              {job.type}
                            </span>
                          </div>
                    ...
                    <Link
                      href="/signup"
                      className="inline-flex items-center justify-center gap-2 bg-[#0A065D] text-white px-6 py-3 rounded-xl font-semibold hover:bg-[#0080FF] transition-all hover:scale-105 shadow-lg whitespace-nowrap"
                    >
            ...
            <div className="text-center">
              <Link
                ...
                className="inline-flex items-center gap-2 bg-white border-2 border-[#0A065D] text-[#0A065D] px-8 py-4 rounded-xl font-semibold hover:bg-[#0A065D] hover:text-white transition-all hover:scale-105 shadow-lg"
              >
