...
const FloatingReviewWidget = () => {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 animate-slide-up">
      <div className="bg-white rounded-2xl shadow-2xl border-2 border-cyan-100 p-5 max-w-sm relative overflow-hidden">
        {/* Close button */}
        <button
          onClick={handleClose}
        ...
        <div className="text-center pt-2">
          ...
          {/* Title */}
          <h3 className="text-lg font-bold text-[#0B3D5F] mb-1">
          ...
          <Link
            ...
            className="inline-block w-full px-6 py-3 bg-gradient-to-r from-[#0B3D5F] to-[#0B4D6F] text-white font-semibold rounded-lg
              hover:from-[#0B4D6F] hover:to-[#0B3D5F] transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
          >
