          ...
          <div className={cn(
            ...
            <nav className="hidden xl:flex items-center gap-1">
                  ...
                  <button
                    className={cn(
                      ...
                      activeMenu === menu.id
                        ...
                        : "text-[#1E40AF]/70 hover:text-[#FF8500] hover:bg-[#FF8500]/5"
                    )}
              ...
              <Link
                ...
                className={cn(
                  ...
                  isActive("/carrieres")
                    ? "text-[#FF8500]"
                    : "text-[#1E40AF]/70 hover:text-[#1E40AF] hover:bg-slate-50/50"
                )}
              >
                {t("careers")}
                {isActive("/carrieres") && (
            ...
            <div className="hidden xl:flex items-center gap-1.5">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-semibold text-[#1E40AF]/60 hover:text-[#1E40AF] rounded-lg hover:bg-slate-100 transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1E40AF]/30"
              >
                  ...
                  <AnimatePresence>
                    {showUserMenu && (
                      ...
                      >
                        ...
                        <div className="py-1">
                          <Link href="/profile" onClick={() => setShowUserMenu(false)} className="flex items-center gap-2 px-3 py-2 text-sm text-[#1E40AF]/70 hover:bg-[#1E40AF]/5 hover:text-[#1E40AF] transition-colors">
                            <User className="h-3.5 w-3.5" />
                            {language === "fr" ? "Mon profil" : "My Profile"}
                          </Link>
                          <Link href="/mes-resultats" onClick={() => setShowUserMenu(false)} className="flex items-center gap-2 px-3 py-2 text-sm text-[#1E40AF]/70 hover:bg-[#1E40AF]/5 hover:text-[#1E40AF] transition-colors">
                            <FileText className="h-3.5 w-3.5" />
                            {language === "fr" ? "Mes résultats" : "My Results"}
                          </Link>
                          <Link href="/laisser-un-avis" onClick={() => setShowUserMenu(false)} className="flex items-center gap-2 px-3 py-2 text-sm text-[#1E40AF]/70 hover:bg-[#1E40AF]/5 hover:text-[#1E40AF] transition-colors">
            ...
            >
              <div className="w-5 h-4 flex flex-col justify-between">
                <span className="block h-0.5 w-5 bg-[#1E40AF] rounded-full" />
                <span className="block h-0.5 w-3.5 bg-[#1E40AF] rounded-full" />
                <span className="block h-0.5 w-5 bg-[#1E40AF] rounded-full" />
              </div>
            </button>
          </div>
      ...
      <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
        <SheetContent side="right" className="w-full sm:w-[400px] p-0 border-l-0 flex flex-col">
          <SheetHeader className="px-6 pt-6 pb-4 border-b border-slate-100">
            <SheetTitle className="text-left text-lg font-semibold text-[#1E40AF]">
              Menu
            </SheetTitle>
          </SheetHeader>
              ...
              >
                <Link
                  ...
                  className={cn(
                    ...
                    isActive("/carrieres") ? "text-[#FF8500]" : "text-[#1E40AF] hover:text-[#FF8500]"
                  )}
                >
          ...
          <SheetFooter className="border-t border-slate-100 p-6 gap-3">
              ...
              <>
                ...
                <div className="flex gap-2">
                  <Link href="/profile" onClick={() => setIsMobileMenuOpen(false)} className="flex-1">
                    <button className="w-full py-2.5 text-sm font-medium text-[#1E40AF]/70 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors">
            ...
            <button
              onClick={toggleLanguage}
              className="w-full flex items-center justify-center gap-2 py-2.5 text-sm font-medium text-[#1E40AF]/60 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors"
            >
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive(link.href)
                        ...
                        : "text-[#1E40AF]/70 hover:text-[#FF8500] hover:bg-[#FF8500]/[0.06]"
                    )}
                  >
                    {link.icon && (
                      <div className={cn(
  ...
  return (
    <div className="border-b border-slate-100 last:border-b-0">
      <button
        ...
        className="flex items-center justify-between w-full py-4 text-base font-medium text-[#1E40AF] hover:text-[#FF8500] transition-colors"
      >
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          isActive(link.href)
                            ...
                            : "text-[#1E40AF]/60 hover:text-[#1E40AF] hover:bg-slate-50"
                        )}
                      >
                        {link.icon && (
