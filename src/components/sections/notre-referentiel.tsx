...
export default function NotreReferentiel() {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-[#C5E3FF] to-[#E8F4FC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="p-8 sm:p-10 lg:p-12 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 bg-[#0A065D]/10 px-4 py-2 rounded-full mb-6 w-fit">
                <BookOpen className="w-5 h-5 text-[#FF8500]" />
                <span className="text-[#FF8500] font-semibold text-sm">
              ...
              <p className="text-base sm:text-lg text-[#1E40AF]/70 leading-relaxed mb-8">
                {language === 'fr'
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all">
            <div className="w-12 h-12 bg-[#FF8500]/10 rounded-xl flex items-center justify-center mb-4">
              <BookOpen className="w-6 h-6 text-[#FF8500]" />
            </div>
            <h3 className="text-lg font-bold text-[#1E40AF] mb-2">
              {language === 'fr' ? 'Informations Détaillées' : 'Detailed Information'}
            </h3>
            <p className="text-[#1E40AF]/60 text-sm leading-relaxed">
              {language === 'fr'
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all">
            <div className="w-12 h-12 bg-[#FF8500]/10 rounded-xl flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-[#FF8500]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
