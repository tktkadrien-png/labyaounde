  ...
  return (
    <section ref={ref as React.RefObject<HTMLElement>} className="overflow-hidden">
      ...
      <div className="relative h-[400px] md:h-[500px] lg:h-[550px] overflow-hidden">
        ...
        {/* Header Content */}
        <div className={`relative z-10 h-full flex items-center justify-center transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
      ...
      <div className="py-16 md:py-24 bg-white">
        <div className={`max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
