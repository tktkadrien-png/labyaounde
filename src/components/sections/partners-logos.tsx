...
export default function PartnersLogos() {
  ...
  return (
    <section className="py-20 md:py-28 bg-gradient-to-br from-[#0A065D] via-[#0D1B6D] to-[#0A065D] relative overflow-hidden">
      {/* Premium Background decorations */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#1E3A8A]/30 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2"></div>
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#1E40AF]/25 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2"></div>
