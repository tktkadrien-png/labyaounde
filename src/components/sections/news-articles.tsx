...
const ArticleCard = ({ article }: { article: Article }) => (
  ...
  >
    ...
    />
    <div className="absolute inset-0 bg-gradient-to-t from-[#0B3D5F]/80 via-[#0B3D5F]/20 to-transparent"></div>
    <div className="absolute top-4 left-4 z-10 bg-cyan-500 text-white text-xs font-bold py-1.5 px-3 rounded-md shadow-md">
      LabYaounde
    </div>
    ...
    <section ref={ref as React.RefObject<HTMLElement>} className="bg-gray-50 py-20 lg:py-24">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className={`text-center mb-14 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-[#0B3D5F]">
            Actualités
          </h2>
